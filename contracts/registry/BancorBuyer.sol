...
contract BancorBuyer {
        ...
        internal
    {
        ...
        balances[buyer] = balances[buyer].sub(_value);
        tokenBalances[buyer][token] = tokenBalances[buyer][token]
        ...
        public
    {
        ...
        buyInternal(msg.sender, ERC20(_token), _exchange, _value, _data);
    }
    ...
    {
        balances[msg.sender] = balances[msg.sender].add(msg.value);
        buyInternal(msg.sender, ERC20(_tokens[0]), _exchanges[0], _values[0], _data1);
    }
        ...
        public
    {
        balances[msg.sender] = balances[msg.sender].add(msg.value);
        buyInternal(msg.sender, ERC20(_tokens[0]), _exchanges[0], _values[0], _data1);
        buyInternal(msg.sender, ERC20(_tokens[1]), _exchanges[1], _values[1], _data2);
    }
        ...
        public
    {
        ...
        buyInternal(msg.sender, ERC20(_tokens[0]), _exchanges[0], _values[0], _data1);
        buyInternal(msg.sender, ERC20(_tokens[1]), _exchanges[1], _values[1], _data2);
        buyInternal(msg.sender, ERC20(_tokens[2]), _exchanges[2], _values[2], _data3);
    }
        ...
        public
    {
        balances[msg.sender] = balances[msg.sender].add(msg.value);
        for (uint i = 0; i < _tokens.length; i++) {
            buyInternal(msg.sender, ERC20(_tokens[i]), _exchanges[i], _values[i], _datas[i]);
        }
    }
